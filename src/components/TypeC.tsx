  ...
  return (
    ...
    {elements.map((element,index) => {
      ...
      return element && (
        ...
        <EquipmentElement key={index} category={EquipmentTypes.B}  demandFactor={demandFactor} onRemoveClick={onRemoveClick} setElementState={setElementState} index={index} initialState={{...element,demandFactor}} />
        </Grid>
